...
func (app *application) CreateCustomerAndSubscribeToPlan(w http.ResponseWriter, r *http.Request) {
	...
	if okay {
		...
		// for now every transaction is a new customer
		// in production we would handle this appropriately
		...
		// Subscriptions store SubscriptionID in PaymentIntent
		...
		inv := Invoice{
			...
			Amount:    2000,                               //TODO this should come from the order / a lookup
			Product:   "Bronze Plan monthly subscription", //TODO should look up from DB...
...
func (app *application) CreateAuthToken(w http.ResponseWriter, r *http.Request) {
	...
	// get user from database, send error if invalid
...
func (app *application) RefundCharge(w http.ResponseWriter, r *http.Request) {
	...
	// TODO normally validate amount against underlying order
